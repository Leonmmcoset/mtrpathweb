...
def generate_image(pattern, shortest_distance, riding_time, waiting_time,
    ...
    draw_text(draw, (10, y), f'路线数据版本 Route data version: {version2}',
              'black', fonts, 16)
    y += 24
    draw_text(draw, (0, y), f'--------------------------------------------------------------------------',
              'black', fonts, 16)
    y += 30
    draw_text(draw, (10, y), f'Leon开服网导航系统生成', 'black', fonts, 20)
    y += 30
    draw_text(draw, (10, y), f'Generated by:', 'black', fonts, 16)
    y += 24
    draw_text(draw, (10, y), f'Leon Server Opening', 'black', fonts, 20)
    y += 30
    draw_text(draw, (10, y), f'Network Navigation System', 'black', fonts, 20)
